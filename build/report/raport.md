...
Wygenerowano: `2026-07-05 18:40:50`

Katalog z wynikami: `/Users/lukasz/Documents/Repositories/starlink-htsim/build/results`
...
| case                           | group             | num_planes | sats_per_plane | num_sats | routing_only | availability_pct | mean_rtt_ms | p95_rtt_ms | route_changes_per_min | mean_route_segment_duration_s | mean_isl_hops | mean_dijkstra_cpu_ms |
| ------------------------------ | ----------------- | ---------- | -------------- | -------- | ------------ | ---------------- | ----------- | ---------- | --------------------- | ----------------------------- | ------------- | -------------------- |
| A_sanity_2sat_adjacent         | A sanity          | 1          | 2              | 2        | True         | 12.646           | 10.462      | 12.275     | 0.200                 | 75.000                        | 0.000         | 0.037                |
| B_1plane_16sat_adjacent        | B small scale     | 1          | 16             | 16       | True         | 0.000            |             |            | 0.100                 |                               |               | 0.179                |
| B_1plane_4sat_adjacent         | B small scale     | 1          | 4              | 4        | True         | 0.000            |             |            | 0.100                 |                               |               | 0.065                |
| B_1plane_8sat_adjacent         | B small scale     | 1          | 8              | 8        | True         | 0.000            |             |            | 0.100                 |                               |               | 0.105                |
| B_2planes_16sat                | B small scale     | 2          | 16             | 32       | True         | 0.000            |             |            | 0.100                 |                               |               | 0.407                |
| B_4planes_16sat                | B small scale     | 4          | 16             | 64       | True         | 0.000            |             |            | 0.100                 |                               |               | 0.905                |
| C_NY_Seattle_12planes          | C NY-Seattle      | 12         | 66             | 792      | True         | 100.000          | 31.916      | 33.587     | 1.613                 | 36.212                        | 1.928         | 12.044               |
| C_NY_Seattle_24planes          | C NY-Seattle      | 24         | 66             | 1584     | True         | 100.000          | 30.923      | 31.275     | 2.929                 | 19.485                        | 3.520         | 23.891               |
| C_NY_Seattle_6planes           | C NY-Seattle      | 6          | 66             | 396      | True         | 100.000          | 42.783      | 60.424     | 1.363                 | 43.040                        | 5.038         | 6.200                |
| D_London_NY_12planes_ping      | D London-NY ping  | 12         | 66             | 792      | False        | 100.000          | 42.695      | 43.327     | 2.104                 | 27.571                        | 5.358         | 12.549               |
| D_London_NY_24planes_ping      | D London-NY ping  | 24         | 66             | 1584     | False        | 100.000          | 42.724      | 43.293     | 3.005                 | 19.000                        | 6.688         | 24.599               |
| D_London_NY_6planes_ping       | D London-NY ping  | 6          | 66             | 396      | False        | 100.000          | 43.134      | 44.523     | 1.402                 | 41.857                        | 7.132         | 5.717                |
| E_NY_Seattle_24planes_isl1000  | E ISL sensitivity | 24         | 66             | 1584     | False        | 100.000          | 31.113      | 31.748     | 3.706                 | 15.216                        | 3.372         | 24.751               |
| E_NY_Seattle_24planes_isl10000 | E ISL sensitivity | 24         | 66             | 1584     | False        | 100.000          | 31.113      | 31.748     | 3.706                 | 15.216                        | 3.372         | 24.366               |
| E_NY_Seattle_24planes_isl5000  | E ISL sensitivity | 24         | 66             | 1584     | False        | 100.000          | 31.113      | 31.748     | 3.706                 | 15.216                        | 3.372         | 23.934               |

Pełna tabela została zapisana do `summary_metrics.csv`.

### Metryki kolejek

| case                           | queue_samples | max_queue_bytes | mean_lastq_bytes | max_lastq_bytes | max_queue_buffer_bytes | max_last_dropped | max_cumulative_drop | max_cumulative_arrivals |
| ------------------------------ | ------------- | --------------- | ---------------- | --------------- | ---------------------- | ---------------- | ------------------- | ----------------------- |
| A_sanity_2sat_adjacent         | 0             |                 |                  |                 |                        |                  |                     |                         |
| B_1plane_16sat_adjacent        | 0             |                 |                  |                 |                        |                  |                     |                         |
| B_1plane_4sat_adjacent         | 0             |                 |                  |                 |                        |                  |                     |                         |
| B_1plane_8sat_adjacent         | 0             |                 |                  |                 |                        |                  |                     |                         |
| B_2planes_16sat                | 0             |                 |                  |                 |                        |                  |                     |                         |
| B_4planes_16sat                | 0             |                 |                  |                 |                        |                  |                     |                         |
| C_NY_Seattle_12planes          | 0             |                 |                  |                 |                        |                  |                     |                         |
| C_NY_Seattle_24planes          | 0             |                 |                  |                 |                        |                  |                     |                         |
| C_NY_Seattle_6planes           | 0             |                 |                  |                 |                        |                  |                     |                         |
| D_London_NY_12planes_ping      | 8619987       | 1500.000        | 146.125          | 1500.000        | 30000.000              | 1500.000         | 0.000               | 0.000                   |
| D_London_NY_24planes_ping      | 12489726      | 1500.000        | 191.389          | 1500.000        | 30000.000              | 1500.000         | 0.000               | 0.000                   |
| D_London_NY_6planes_ping       | 5998461       | 1500.000        | 31.818           | 1500.000        | 30000.000              | 1500.000         | 0.000               | 0.000                   |
| E_NY_Seattle_24planes_isl1000  | 19016643      | 1500.000        | 20.280           | 1500.000        | 30000.000              | 1500.000         | 0.000               | 0.000                   |
| E_NY_Seattle_24planes_isl10000 | 19016643      | 1500.000        | 20.279           | 1500.000        | 30000.000              | 1500.000         | 0.000               | 0.000                   |
| E_NY_Seattle_24planes_isl5000  | 19016643      | 1500.000        | 20.279           | 1500.000        | 30000.000              | 1500.000         | 0.000               | 0.000                   |

Pełna tabela została zapisana do `queue_metrics.csv`.

## 7. Najważniejsze obserwacje automatyczne

- Najwyższą dostępność trasy ma `C_NY_Seattle_12planes`: 100.00%. Najniższą dostępność ma `B_1plane_16sat_adjacent`: 0.00%.
- Najniższy średni RTT wśród próbek z istniejącą trasą ma `A_sanity_2sat_adjacent`: 10.462 ms.
- Dla benchmarków NY-Seattle średnie RTT wynosi: C_NY_Seattle_6planes=42.78 ms, C_NY_Seattle_12planes=31.92 ms, C_NY_Seattle_24planes=30.92 ms.
- Najczęstsze zmiany tras występują w `E_NY_Seattle_24planes_isl1000`: 3.706 zmian/min.
- Najwyższy średni koszt Dijkstry zanotowano w `E_NY_Seattle_24planes_isl1000`: 24.7515 ms.
- Największe zaobserwowane zajęcie kolejki ma `D_London_NY_12planes_ping`: 1500 B.
